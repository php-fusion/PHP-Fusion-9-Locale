...
$locale['setup_3803'] = "Ahoj [RECEIVER],<br/>Dostali ste novú súkromnú správu s názvom [SUBJECT] od [USER] na [SITENAME]. Môžete si prečítať súkromnú správu na adrese [SITEURL]messages.php<br/>Správa: [MESSAGE]<br/>YAk už nechcete dostávať nové správy, môžete vypnúť upozornenie e-mailom, prostredníctvom panelu možností na stránke Súkromná správa.<br/>S pozdravom,<br/>[SENDER].";
