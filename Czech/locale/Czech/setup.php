...
$locale['setup_3803'] = "Ahoj [RECEIVER],<br/>Obdrželi jste novou zprávu s názvem Soukromá zpráva [SUBJECT] z [USER] na [SITENAME]. Můžete si přečíst soukromou zprávu na adrese [SITEURL]messages.php<br/>Zpráva: [MESSAGE]<br/>Pokud již nechcete být upozorněni na nové zprávy, můžete vypnout upozornění e-mailem prostřednictvím panelu možností na stránce Soukromá zpráva.<br/>S pozdravem,<br/>[SENDER].";
$locale['setup_3804'] = "Oznámení o nových příspěvcích na fóru";
$locale['setup_3805'] = "Oznámení odpovědi na téma - [SUBJECT]";
$locale['setup_3806'] = "Ahoj [RECEIVER],<br/>Odpověď byla zaslána do fóra \'[SUBJECT]\' které sledujete at [SITENAME]. Pro zobrazení odpovědi můžete použít následující odkaz:<br/>[THREAD_URL]<br/>Pokud už nechcete sledovat tento podproces, můžete kliknout na něj \'Zastavte sledování tohoto podprocesu\' odkaz umístěný v horní části závitu.<br/>S pozdravem,<br/>[SENDER].";
...
$locale['weblinks']['description'] = "Webový systém odkazů.";
