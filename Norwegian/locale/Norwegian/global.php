...
$locale['add'] = "Legg til";
$locale['save'] = "Lagre";
$locale['save_changes'] = "Lagre endringene";
...
$locale['unpublish'] = "Upubliser";
$locale['draft'] = "Utkast";
$locale['settings'] = "Innstillinger";
$locale['posted'] = "lagt ut";
$locale['profile'] = "Profil";
$locale['edit'] = "Redigere";
$locale['qedit'] = "Hurtig redigering";
$locale['view'] = "Se på";
$locale['login'] = "Logg inn";
$locale['logout'] = "Logg ut";
$locale['admin-logout'] = "Admin Logg ut";
$locale['message'] = "Privat Melding";
$locale['logged'] = "Logget inn som ";
$locale['version'] = "Versjon ";
$locale['browse'] = "Søk ...";
$locale['close'] = "Steng";
...
$locale['ratings'] = "Rangering";
$locale['comments_ratings'] = "Kommentarer og rangeringer";
$locale['user_account'] = "Bruker Konto";
$locale['about'] = "Handle om";
// User status
$locale['online'] = "På nett";
$locale['offline'] = "Offline";
// Words for formatting to single and plural forms. Count of forms is language-dependent
$locale['fmt_submission'] = "innsending|innsendinger";
$locale['fmt_article'] = "artikkel|artikler";
$locale['fmt_blog'] = "blogg|blogger";
$locale['fmt_comment'] = "kommentar|kommentarer";
$locale['fmt_vote'] = "stemme|stemmer";
$locale['fmt_rating'] = "rangering|rangeringer";
$locale['fmt_day'] = "dag|dager";
$locale['fmt_download'] = "nedlasting|nedlastinger";
$locale['fmt_follower'] = "følger|følgere";
$locale['fmt_forum'] = "forum|forum";
$locale['fmt_guest'] = "gjest|gjester";
$locale['fmt_hour'] = "time|timer";
$locale['fmt_item'] = "artikkel|artikkler";
$locale['fmt_member'] = "medlem|medlemmer";
$locale['fmt_message'] = "beskjed|beskjeder";
$locale['fmt_minute'] = "minutt|minutter";
$locale['fmt_month'] = "måned|måneder";
$locale['fmt_news'] = "nyhet|nyheter";
$locale['fmt_photo'] = "foto|fotogafier";
$locale['fmt_post'] = "innlegg|innlegg";
$locale['fmt_question'] = "spørsmål|spørsmål";
$locale['fmt_read'] = "lese|leser";
$locale['fmt_second'] = "sekund|sekunder";
$locale['fmt_shouts'] = "rope|roper";
$locale['fmt_thread'] = "tråd|tråder";
$locale['fmt_user'] = "bruker|brukere";
$locale['fmt_views'] = "vise|viser";
$locale['fmt_weblink'] = "weblik|weblinks";
